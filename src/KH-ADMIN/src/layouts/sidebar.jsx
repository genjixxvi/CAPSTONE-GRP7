    ...
    return (
        ...
        >
            <div className="flex gap-x-3 p-3">
                ...
                />
                {!collapsed && <p className="text-lg font-medium text-slate-900 transition-colors dark:text-slate-50">KnowledgeHub</p>}
            </div>
                    ...
                    >
                        ...
                        {navbarLink.links.map((link) => (
                            <NavLink
                                ...
                                onClick={() => link.action === "logout" && handleAction(link.action)}
                            >
                                <link.icon
                                    size={22}
